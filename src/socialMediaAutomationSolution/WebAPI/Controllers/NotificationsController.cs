...
public class NotificationsController : BaseController
{
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult<DeletedNotificationResponse>> Delete([FromRoute] Guid id)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetByIdNotificationResponse>> GetById([FromRoute] Guid id)
    {
